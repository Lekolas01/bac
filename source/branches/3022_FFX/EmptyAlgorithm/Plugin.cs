...
namespace EmptyAlgorithm {
  [Plugin("EmptyAlgorithm", "1.0")]
  [PluginFile("EmptyAlgorithm.dll", PluginFileType.Assembly)] // each plugin represents a collection of files. The minimum is one file; the assembly.
