...
namespace EmptyPlugin {
  [Plugin("EmptyPlugin", "1.0")]
  [PluginFile("EmptyPlugin.dll", PluginFileType.Assembly)] // each plugin represents a collection of files. The minimum is one file; the assembly.
